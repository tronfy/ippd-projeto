...
{
    /*
     * Static : 3.23x (Sequencial: 4.3391s | Static: 1.3452s)
       Guided: 3.46x (Sequencial: 4.3855s | Guided: 1.2667s)
       Dynamic 2.64x (Sequencial: 4.5713s | Dynamic: 1.7321s)
    */
...
#pragma omp parallel
    {
        ...
        /*
            Static: 3.46x (Sequencial: 4.3855s | Static: 1.2667s)
            Guided: 2.44x (Sequencial: 4.6885s | Guided: 1.9186s)
            Dynamic: 3.12x (Sequencial: 4.4640s | Dynamic: 1.4294s)
        */
